...
public interface EventService {
    ...
    List<Event> search(HttpServletRequest httpServletRequest, String text, List<Long> categories, Boolean paid,
                       LocalDateTime rangeStart, LocalDateTime rangeEnd, Boolean onlyAvailable, SortEvent sort, Pageable page);

    List<Event> searchAdmin(List<Long> users, List<StateEvent> states, List<Long> categories, LocalDateTime rangeStart,
